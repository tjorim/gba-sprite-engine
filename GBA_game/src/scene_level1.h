...
private:
    ...
    int amtSpikeBallSpawns, spikeBallSpawn, portalLocation;
    int scrollX, scrollY;
public:

    SceneLevel1(std::shared_ptr<GBAEngine> engine) : Scene(engine), scrollX(0), scrollY(60), amtSpikeBallSpawns(0), spikeBallSpawn(GBA_SCREEN_WIDTH - 100),portalLocation(1000) {}
